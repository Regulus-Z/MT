...
#################################fmax(2000)
        ...
        self.conformer_encoder11 = ConformerEncoder(
            input_dim=128,
            encoder_dim=512,
            num_layers=2,
            num_attention_heads=8,
        ...
        self.conformer_encoder22 = ConformerEncoder(
            input_dim=128,
            encoder_dim=512,
            num_layers=2,
            num_attention_heads=8,
        ...
        self.conformer_encoder33 = ConformerEncoder(
            input_dim=128,
            encoder_dim=512,
            num_layers=2,
            num_attention_heads=8,
        ...
        Ndim=512
        self.fc_1 = nn.Linear(Ndim, Ndim)
        self.fc_2 = nn.Linear(Ndim, Ndim)
        self.fc_3 = nn.Linear(Ndim, Ndim)
        self.fc_final = nn.Linear(3*Ndim, classes_num)
        self.init_weights()

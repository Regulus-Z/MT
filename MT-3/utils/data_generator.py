...
class DataGenerator(object):
    ...
    def read_batch_audio(self, batch_audio_indexes, data_type, generate_type):
        ...
        for ind in range(0, len(batch_audio_indexes)):
            ...
            #########################
            audio, fs = read_audio(os.path.join(self.dataset_dir,'breathing-deep', 'audio', audio_name))
            audio_2,fs_2=read_audio(os.path.join(self.dataset_dir,'counting-normal', 'audio', audio_name))
            audio_3,fs_3=read_audio(os.path.join(self.dataset_dir,'vowel-o', 'audio', audio_name))
            #########################
        ...
        return batch_audio,batch_audio_2,batch_audio_3,batch_audio_name
